...
# Выгрузка
load_spreadsheet_id = '1i5rF5HIb0RoX2_SmjGFLjVYIdIgVB-nnRzvz_PqbF_k'
...
load_sheet.write_values('Результат!A1:I', [list(itog.columns)])
load_sheet.write_values('Результат!A2:I', itog.values.tolist())